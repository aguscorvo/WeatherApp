...
import { compareBtn, locationInput, setBtnActive, setBtnInactive, setShowActive, setShowInactive, } from './main.js';
...
export const sweetAlertError = (message) => Swal.fire({
    heightAuto: false,
    title: 'Ups...',
    text: message,
    icon: 'error',
...
export const sweetAlertWarning = (message) => Swal.fire({
    heightAuto: false,
    title: 'Advertencia',
    text: message,
    icon: 'warning',
...
export const sweetAlertInfo = (message) => Swal.fire({
    heightAuto: false,
    text: message,
    icon: 'info',
    showCloseButton: true,
